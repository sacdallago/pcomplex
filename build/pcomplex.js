...
class PComplex {
    ...
    constructor(tracks, options){
        ...
        curvesCollector
            ...
            .attr("d", function(d){
                let data = d.partners.map(function(interaction) {
                    return {
                        x: interaction.time,
                        y: d.protein
                    }
        ...
        // Add event to hover on tracks: just append "show" to circles on the track and the track itself!
        curvesCollector.selectAll("path")
            .on('mouseover', function(d) {
                curvesCollector.selectAll('path.' + d.protein).classed("show", true);
                circlesCollector.selectAll("." + d.protein).selectAll("circle").classed("show", true);
            })
            .on('mouseout', function() {
                tooltip.classed("show", false);
                circlesCollector.selectAll('circle').classed("show", false)
                curvesCollector.selectAll('path').classed("show", false);
            });
    }
}
