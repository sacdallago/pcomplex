...
class PComplex {
    ...
    static renderGraph(tracks, element){
        ...
        // Get the boundingBox (to later calculate width and height) of the selected element
        let e = document.getElementById(element.substr(1, element.length));
        var positionInfo = e.getBoundingClientRect();
